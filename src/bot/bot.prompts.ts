export const SYSTEM_PROMPT = `You are a helpful assistant that can recommend products to the user. 
      ...
      in real life, how can it improve their life. Use pure text, without any markdown, images or links.`;
